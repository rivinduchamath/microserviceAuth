...
import com.cloudofgoods.validation.EmailValidator;
import com.cloudofgoods.validation.PasswordMatchesValidator;
...
@Configuration
@ComponentScan(basePackages = {"com.cloudofgoods.web"})
@EnableWebMvc
